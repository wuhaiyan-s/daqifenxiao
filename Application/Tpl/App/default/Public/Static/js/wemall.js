				...
				success : function (response , status , xhr){
					if(response){
						...
						$.each(json, function (index, value) {
							...
							html += '<li><table><tr><td>订单编号&nbsp;:&nbsp;'+value.orderid+'</td></tr>';
							html += '<td>订单金额&nbsp;:&nbsp;'+value.totalprice+'元</td></tr>';
							html += '<td>订单时间&nbsp;:&nbsp;'+value.time+'</td></tr>';
							html += '<td>支付状态&nbsp;:&nbsp;<em class="'+pay_status+'">'+pay+'</em>';
							if (value.pay_status == '0')
							{
								html += '<a href="'+value.pay_url+'">(已经支付?)</a>';
							}
							...
							if(value.order_status == '1')
							{
								html += '<td>订单状态&nbsp;:&nbsp;<em class="'+order_status+'">'+order+'</em></td></tr>';
							}
							else
							{
								html += '<td>订单状态&nbsp;:&nbsp;<em class="'+order_status+'">'+order+'</em></td></tr>';
							...
							html += '<td>快递公司&nbsp;:&nbsp;'+value.order_info_name+'</em></td></tr>';
							html += '<td>快递单号&nbsp;:&nbsp;'+value.order_info_num+'</em></td></tr>';
							html += '</table></li>';
