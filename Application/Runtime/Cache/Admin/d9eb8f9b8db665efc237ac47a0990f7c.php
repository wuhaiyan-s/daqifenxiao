...
<style type="text/css" media="screen">
	...
	.goodsimageLi span.setCover{
		float: left;
	}
	.goodsimageLi span.delImg{
		background: #d9534f;
		float: right;
	}
	.goodsimageLi b{
...
<div class="col-sm-12 widget-container-span">
	<div class="widget-box transparent">
										...
										<table cellpadding="2" cellspacing="2" width="100%">
											<tbody>
												...
												<tr>
													<td>商品图片:</td>
													<td>
														<li class="goodsimageLi"><b>图片1</b>
															<input multiple="multiple" type="file" name="goodsimage[0][file]" class="goodsfile">
															...
															<img src="./Public/Uploads/goods_default.png" class="goodsimage"/>
														...
														<li class="goodsimageLi"><b>图片2</b>
															<input multiple="multiple" type="file" name="goodsimage[1][file]" class="goodsfile">
														...
														<li class="goodsimageLi"><b>图片3</b>
															<input multiple="multiple" type="file" name="goodsimage[2][file]" class="goodsfile">
														...
														<li class="goodsimageLi"><b>图片4</b>
															<input multiple="multiple" type="file" name="goodsimage[3][file]" class="goodsfile">
														...
														<li class="goodsimageLi"><b>图片5</b>
															<input multiple="multiple" type="file" name="goodsimage[4][file]" class="goodsfile">
														...
														<p class="help-block">允许的附件文件类型: jpg,gif,png,jpeg并且图片大小小于200k，图片宽高比例为1:1，第一张图片作为封面图片。</p>
													</td>
												</tr>
												<tr>
													<td>商品状态:</td>
			...
			function reGood(goodsId) {
				$.post("<?php echo U('Admin/Good/getgoodid');?>",{"id":goodsId},function(data){
					...
					for( var i = 0; i < images.length;i++ ){
						$('.goodsimage').eq(i).attr('src',"<?php echo ($UploadDir); ?>"+images[i].src);
	    ...
	    function delImg(imgSort)
	    {
		    ...
		    $('.goodsimage').eq(imgSort).attr('src',"<?php echo ($UploadDir); ?>goods_default.png");
	    }
	    
	    //html5实现图片预览功能
        $(function () {
            $(".goodsfile").change(function (e) {
	            var fileObj = $(this);
                ...
                if (file) {
                    ...
                    reader.onload = function () {
	                    fileObj.parent().find('.goodsimage').attr('src',this.result);
