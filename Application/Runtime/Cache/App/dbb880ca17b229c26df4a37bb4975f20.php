		...
		<div class="div_header">
			...
			<span class="header_right">
				<div class="header_l_di">
					...
					<<a style='color:red' href="./index.php?g=App&m=Member&a=base">账号设置</a>>
				</div>
				<div><span>代理：<?php if($users["member"] == 1): ?>是<?php else: ?>否(<a style='color:red' href='http://c.6gcc.com/weixin/index.php?g=App&m=Index&a=listsp&id=1'></a>)<?php endif; ?></span></div>
				<div><span>关注时间：<?php echo date('Y-m-d',$wx_info['subscribe_time']); ?></span></div>
		<!-- 				<div><span> 会员ID：<?php echo ($users["id"]); ?> </span></div> -->
				<div><span><a style='color:red' href="./index.php?g=App&m=Member&a=logout">退出登录</a></span></div>
		</div>
...
<!-- 		<div class="cardexplain" style="TEXT-ALIGN: center;color:#000;font-size:14px;">您是由【<?php echo ($l_name); ?>】推荐</div> -->
		...
		<div class="cardexplain">
			<div class="div_ul" id="all_cnt" ><span><img style='margin-left:5px;' src="./Application/Tpl/App/default/Public/Static/images/arrow_unclick.png">家族成员</span><span class="bg_total"><?php echo ($all_cnt); ?> 人</span></div>
			<ul class="round">
				<li class="member_cnt" style=""><a href="<?php echo ($type_a_url); ?>"><span><img style="width:20px;height:20px;" src="./Application/Tpl/App/default/Public/Static/images/bullet_blue_expand.png">一级会员<span style="float:right;color:red;"><?php echo ($users["a_cnt"]); ?></span></span></a></li>
				<li class="member_cnt"><a href="<?php echo ($type_b_url); ?>"><span><img style="width:20px;height:20px;"  src="./Application/Tpl/App/default/Public/Static/images/bullet_blue_expand.png">二级会员<span style="float:right;color:red;"><?php echo ($users["b_cnt"]); ?></span></span></a></li>
				<li class="member_cnt"><a href="<?php echo ($type_c_url); ?>"><span><img style="width:20px;height:20px;" src="./Application/Tpl/App/default/Public/Static/images/bullet_blue_expand.png">三级会员<span style="float:right;color:red;"><?php echo ($users["c_cnt"]); ?></span></span></a></li>
			</ul>
		</div>
		
		<div class="cardexplain">
			
			<div class="div_ul" id="all_buy"><span><img style='margin-left:5px;' src="./Application/Tpl/App/default/Public/Static/images/arrow_unclick.png">家族推广<span class="bg_total"><?php echo ($all_count_buy); ?> 单</span></span></div>
			<ul class="round">
		...
		<div class="cardexplain">
			<div class="div_ul" id="all_price"><span><img style='margin-left:5px;'  src="./Application/Tpl/App/default/Public/Static/images/arrow_unclick.png">我的佣金<span class="bg_total"><?php echo ($all_price); ?> 元</span></span></div>
			<ul class="round">
...
-->
		<div class="cardexplain">
			<a href = './index.php?g=App&m=Index&a=member_top&id=<?php echo ($users["id"]); ?>'><div class="div_ul" id="top_url"><span><img style='margin-left:5px;' src="./Application/Tpl/App/default/Public/Static/images/arrow_unclick.png">销售排行榜</span></div></a>
		</div>
		<div style="text-align:center;"></div>
	</div>
	
	<div id="ticket-container" style="display: none;">
		<div class="ticket_txt_t">消费变投资 人人都能当老板</div>
		<div class="ticket_img"><img src='<?php echo ($ticket); ?>'></div>
		<div class="ticket_txt_b">分享此二维码 成为平台合伙人<br/>别人消费你赚钱</div>
	</div>
	...
	<div id="user-container" style="display: none;">
		...
		<div>
			<ul class="round" style="margin:0;padding:0;border-radius:0;border:0px;border-bottom:1px solid #C6C6C6">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cpbiaoge">
					<tr>
						<td> <span class="orderlist_pagetitle">订单列表</span> <span style='float:right'><a href='javascript:$("#ticket").click();' style='color:red;'>获取推广二维码>>></a></span> </td>
					</tr>
				</table>
			</ul>
		</div>
		...
		<div class="cardexplain">
			...
			<ul class="round"  id="orderlistinsert">
				<!--插入订单ul-->
			</ul>
		</div>
	</div>
	...
	<div class="footermenu">
		<ul>
			<li ><a href="./index.php?g=App&m=Index&a=index"> <img src="./Application/Tpl/App/default/Public/Static/images/21.png">
					<p>首页</p>
			</a></li>
			<li id="user"><a href="javascript:void(0);"> <img src="./Application/Tpl/App/default/Public/Static/images/22.png">
					<p>订单</p>
			</a></li>
			<li id="member"><a href="javascript:void(0);" class="active"> <img src="./Application/Tpl/App/default/Public/Static/images/23.png">
					<p>销售业绩</p>
			</a></li>
			<li id="ticket"><a href="javascript:void(0);"> <img src="./Application/Tpl/App/default/Public/Static/images/24.png">
					<p>我的二维码</p>
			</a></li>
		</ul>
	</div>
