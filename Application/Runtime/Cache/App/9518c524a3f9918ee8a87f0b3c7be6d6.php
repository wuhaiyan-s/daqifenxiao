	...
	<head>
		...
		<body class="sanckbg mode_webapp">
			...
			<span class="header_right">
				...
				<div><span>代理：<?php if($users["member"] == 1): ?>是<?php else: ?>否(<a style='color:red' href='./index.php?g=App&m=Index&a=index'>点击链接成为代理</a>)<?php endif; ?></span></div>
									...
									<table style="padding: 0; margin: 0; width: 100%;">
										<tbody>
											...
											<tr>
												...
												<td>
													<div>
														<?php if ($users['head_img']) { ?>
														<div class="por">
															<img src="__PUBLIC/head_img/<?php echo ($users["head_img"]); ?>" id="portrait_src">
														</div>
														<?php } ?>
														<input name="head_img" value="<?php echo ($users["head_img"]); ?>" type="file">
													</div>
												</td>
											</tr>
