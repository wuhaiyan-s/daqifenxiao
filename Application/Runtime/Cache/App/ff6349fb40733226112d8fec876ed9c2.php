...
<div class="index-con">
	...
	<div id="carousel-example-generic" class="carousel slide m-slider " data-ride="carousel">
	  ...
	  <ol class="carousel-indicators">
		  	<?php if(is_array($ads)): $n = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($n % 2 );++$n;?><li data-target="#carousel-example-generic" data-slide-to="0" class="<?php if($n == 1) echo 'active';?>"></li><?php endforeach; endif; else: echo "" ;endif; ?>
	  </ol>
	
	  <!-- Wrapper for slides -->
	  <div class="carousel-inner" role="listbox">
		<?php if(is_array($ads)): $n = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($n % 2 );++$n;?><div class="item <?php if($n == 1) echo 'active';?>" onclick="window.location.href='<?php echo ($ad["url"]); ?>'">
	      <img src="<?php echo ($UploadDir); echo ($ad["image"]); ?>" alt="">
			...
			<div class="item-list-content ban-dom">
				<li class="ban-dom">
					<div class="ui-p-r more-today-pic-div">
						<a href="<?php echo U('Index/detail',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Uploads/<?php echo ($vo["image"]); ?>" alt="图片" class="more-today-pic"></a>
					</div>
					...
					<div class="ui-rows-m more-item-info more-price-info">
						...
						<a class="more-buy-now-btn ui-cols ui-text-right" href="<?php echo U('Index/detail',array('id'=>$vo['id']));?>">立即抢购</i></a>
					</div>
				</li>
			</div>
